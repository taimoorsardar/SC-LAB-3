...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
		...
		// Check if the code is written by oneself or their team
		if (writtenByYourself) {
			return true;  // Code written by oneself can be used	
		}

		// Check if the code is available to others and properly cited
		if (availableToOthers && citingYourSource) {
			return true;  // Code available to others with proper citation can be used
		}

		// Check if the code is part of course work and implementation is required
		if (writtenAsCourseWork && implementationRequired) {
			return true;  // Course work with implementation requirement can be used
		}

		// In all other cases, the code may not be used
		return false;
	}
